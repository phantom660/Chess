...
public class Rook {
    ...
    public boolean isMoveLegal(Board board, int endRow, int endCol) {
        ...
        /*
         - Checks if the movement of Rook is horizontal or vertical
        ...
        */
        ...
        if (board.verifyVertical(this.row, this.col, endRow, endCol) || board.verifyHorizontal(this.row, this.col, endRow, endCol)) {           // Check for horizontal or vertical movement.
            return true;
        }
        return false;
    }
